...
import 'package:vastuarunsharma/presentation/screens/dashboard/components/CoreValuesSection.dart';
import 'package:vastuarunsharma/presentation/widgets/glass_button.dart';
...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  Future<void> _refreshData() async {
    ...
    await Future.wait(<Future>[
      ...
      // No live classes to refresh for guests
    ]);
  }
                ...
                child: Row(
                  children: [
                    ServiceCard(
                      ...
                      actionText: 'Book Now',
                      onTap: () {
                        // scrool to the inquiry form
                        if (_inquiryKey.currentContext != null) {
